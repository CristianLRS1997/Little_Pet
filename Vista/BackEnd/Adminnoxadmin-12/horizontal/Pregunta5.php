        ...
        <div class="row">
            <div class="col-sm-9 center-page">
                <div class="card-box">
                    ...
                    <form method="post" action="../../../../Controlador/respuestaController.php?action=crear5">
                        <input  style='border: hidden' hidden='hidden' value="¿Estás consciente y aceptas los gastos que genera tener un animal de compañía?"
                                class='text-warning' id="Enunciado" name="Enunciado">¿Estás consciente y aceptas los gastos que genera tener un animal de compañía?</input>
