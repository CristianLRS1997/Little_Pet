            ...
            <div class="col-sm-9 center-page">
                <div class="card-box">
                    ...
                    <p class="text-muted font-14 m-b-20">
                       Realizar preguntas para dar en adopcion a tu amigo y asi pueda encontrar un hogar.
                    </p>

                    <form class="" method="post" action="../../../../Controlador/preguntaController.php?action=crear">

                        <div class="form-group">
                            <label>Enunciado</label>
                            <div>
                                <textarea required class="form-control" id="Enunciado" placeholder="Escriba el enunciado de la pregunta" name="Enunciado"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
