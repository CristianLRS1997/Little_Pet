        ...
        <div class="row">
            <div class="col-sm-9 center-page">
                <div class="card-box">
                    ...
                    <form method="post" action="../../../../Controlador/respuestaController.php?action=crear6">
                        <input  style='border: hidden' hidden='hidden' value="¿Qué sucedería si tuvieras que mudarte a otra casa o ciudad /país?"
                                class='text-warning' id="Enunciado" name="Enunciado">¿Qué sucedería si tuvieras que mudarte a otra casa o ciudad /país?</input>
                        <div class="form-group">
                            <textarea style="background-color: #FEF9E7; border:none " id="Respuesta"  class="form-control" name="Respuesta" required
                                      data-parsley-trigger="keyup" data-parsley-minlength="50"
                                      data-parsley-minlength-message="Debe terner almenos una respuesta de 50 caracteres."
                                      data-parsley-validation-threshold="10" placeholder="Responde...."></textarea>
                        </div>
