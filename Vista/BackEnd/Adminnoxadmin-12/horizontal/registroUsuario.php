                            ...
                            <div class="account-content">
                                <form class="form-horizontal" method="post" action="../../../../Controlador/UsuarioController.php?action=crear">
                                    ...
                                    <div class="form-group text-center m-t-10">
                                        <div class="col-xs-12">
                                            <input class="btn btn-md btn-block btn-primary waves-effect waves-light" type="submit">Registrar</input>
                                        </div>
                                    </div>
                                ...
                                <div class="row m-t-50">
                                    <div class="col-sm-12 text-center">
                                        <p class="text-muted">Ya tienes una cuenta?  <a href="page-login.html" class="text-dark m-l-5"><b>Ingresa</b></a></p>
                                    </div>
                                </div>
