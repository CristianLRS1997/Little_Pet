        ...
        <div class="row">
            <div class="col-sm-9 center-page">
                <div class="card-box">
                    ...
                    <form method="post" action="../../../../Controlador/respuestaController.php?action=crear4">

                        <input  style='border: hidden' hidden='hidden' value="¿Estás consciente y aceptas que adoptar un animal es una responsabilidad de 14 a 17 años?"
                                class='text-warning' id="Enunciado" name="Enunciado">¿Estás consciente y aceptas que adoptar un animal es una responsabilidad de 14 a 17 años?</input>
