        ...
        <div class="row">
            <div class="col-sm-9 center-page">
                <div class="card-box">
                    ...
                    <form method="post" action="../../../../Controlador/respuestaController.php?action=crear2">

                        <input  style='border: hidden' hidden='hidden' value="¿Vives en casa propia o arriendo?"
                                class='text-warning' id="Enunciado" name="Enunciado">¿Vives en casa propia o arriendo?</input>
                        <div class="checkbox checkbox-warning">
                            <input id="checkbox5" type="checkbox" name="Respuesta" value="Casa propia" checked>
                            <label for="checkbox5">
                                Casa propia
                            </label>
                        </div>
                        <div class="checkbox checkbox-warning">
                            <input id="checkbox5" type="checkbox" name="Respuesta" value="Arriendo" >
                            <label for="checkbox5">
                                Arriendo
                            </label>
                        </div>
